...
Then navigate to http://127.0.0.1:3000/ (or whatever is your local host/development server) and add on ?latitude=NUMBER_HERE&longitude=NUMBER_HERE&zoom=NUMBER_HERE
